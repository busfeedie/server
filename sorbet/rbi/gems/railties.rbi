...
class Rails::TestUnit::TestParser < Ripper
  def first_arg(arg, *arg1); end
  def initialize(*arg0); end
  def just_lineno(*arg0); end
  def on_arg_paren(arg, *arg1); end
  def on_args_add(parts, part); end
  def on_args_add_block(args, *rest); end
  def on_args_new; end
  def on_bodystmt(arg, *arg1); end
  def on_brace_block(*arg0); end
  def on_command(arg, *arg1); end
  def on_command_call(*arg0, begin_lineno, _args); end
  def on_def(begin_line, *arg1); end
  def on_do_block(*arg0); end
  def on_ident(*arg0); end
  def on_method_add_arg(arg, *arg1); end
  def on_method_add_block(begin_line, end_line); end
  def on_stmts_add(arg, *arg1); end
  def on_stmts_new(*arg0); end
  def parse; end
