...
class MessagePack::Packer
  ...
  def initialize(*arg0); end
  def pack(arg0); end
  def register_type(type, klass, method_name = nil, &block); end
  def register_type_internal(arg0, arg1, arg2); end
...
class MessagePack::Unpacker
  ...
  def register_type(type, klass = nil, method_name = nil, &block); end
  def register_type_internal(arg0, arg1, arg2); end
  def registered_types; end
  def registered_types_internal; end
  def reset; end
...
class MessagePack::Factory
  ...
  def register_type(type, klass, options = nil); end
  def register_type_internal(arg0, arg1, arg2); end
