...
class OpenTelemetry::Exporter::OTLP::Exporter
  ...
  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#370
  def as_otlp_any_value(value); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#362
  def as_otlp_key_value(key, value); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#303
  def as_otlp_span(span_data); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#351
  def as_otlp_span_kind(kind); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#343
  ...
  # @raise [ArgumentError]
  #
  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#416
  def parse_headers(raw); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#388
  def prepare_endpoint(endpoint); end

  # source://opentelemetry-exporter-otlp//lib/opentelemetry/exporter/otlp/exporter.rb#403
